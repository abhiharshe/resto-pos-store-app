...
export const Dropdown: React.FC<DropdownProps> = ({
    ...
    const isDropdowned = (val: string | number) => {
    ...
    const handleDropdown = (option: Option) => {
        if (multiple) {
            ...
            const newValues = isDropdowned(option.value)
            ...
            <div className="relative">
                <div
                    ...
                    className={`
                        ...
                        ${error ? 'border-red-500' : 'border-mauve-200 dark:border-zinc-700'}
                ...
                {isOpen && (
                    <div className="absolute z-50 w-full mt-1 bg-white dark:bg-neutral-800 border border-mauve-200 dark:border-zinc-700 rounded-lg shadow-xl overflow-hidden animate-in fade-in zoom-in duration-200">
