...
const InternetConnectionChecker: React.FC<Props> = ({ children }) => {
    ...
    return (
        <div className="fixed inset-0 z-9999 flex items-center justify-center bg-neutral-50 dark:bg-neutral-950 p-4 overflow-hidden">
            ...
            <div className="relative max-w-md w-full text-center space-y-8 animate-in fade-in zoom-in duration-500">
                ...
                <div className="relative mx-auto w-24 h-24">
                    ...
                    <div className="relative flex items-center justify-center w-full h-full bg-white dark:bg-mauve-900 rounded-3xl border border-zinc-100 dark:border-mauve-800 shadow-xl shadow-indigo-500/10">
                ...
                {/* Status List */}
                <div className="bg-white/50 dark:bg-mauve-900/50 backdrop-blur-md rounded-2xl border border-zinc-100 dark:border-mauve-800 p-6 text-left space-y-4 shadow-sm">
