    ...
    return (
        <div className="space-y-8 max-w-3xl">
            <form onSubmit={formik.handleSubmit} className="space-y-4">
                <h3 className="text-lg font-medium text-neutral-900 dark:text-zinc-100">SMTP Server Configuration</h3>
            ...
            <div className="border-t border-mauve-200 dark:border-zinc-700 pt-8 space-y-4">
                <h3 className="text-lg font-medium text-neutral-900 dark:text-zinc-100">Test Connection</h3>
