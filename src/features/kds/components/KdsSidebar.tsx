                                    ...
                                    {order.items.map((item) => (
                                        <div key={item.id} className="border-b border-zinc-100 dark:border-zinc-800 pb-4 last:border-0 last:pb-0">
                                            ...
                                            <div className="flex justify-between items-center mt-1">
                                                <span className="text-xs text-zinc-500 uppercase font-medium">{item.variant_name}</span>
                                            ...
                                            {item.addons && item.addons.length > 0 && (
                                                <div className="mt-2 pl-4 border-l-2 border-zinc-100 dark:border-zinc-800">
                                                    {item.addons.map(addon => (
                                                        <p key={addon.id} className="text-xs text-zinc-500 italic">
                                                            + {addon.name}
                                                        </p>
                                                    ))}
                                                </div>
