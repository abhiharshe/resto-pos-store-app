    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card>
                    <h4 className="text-sm font-bold text-zinc-400 uppercase tracking-widest mb-6">Recent Store Activity</h4>
                ...
                <Card>
                    <h4 className="text-sm font-bold text-zinc-400 uppercase tracking-widest mb-6">Hourly Traffic Today</h4>
                        ...
                        {[30, 45, 60, 85, 95, 75, 40, 20, 15, 10, 5, 2].map((val, i) => (
                            <div key={i} className="flex-1 flex flex-col items-center gap-2">
                                <div 
                                    ...
                                    style={{ height: `${val}%` }}
                                ></div>
                                <span className="text-[8px] font-bold text-zinc-400 uppercase">{i + 8}h</span>
                            </div>
                        ))}
                    </div>
                </Card>
    ...
    <Card className={`bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 shadow-sm group hover:scale-[1.02] transition-transform duration-300`}>
        ...
        <div className="space-y-1">
            ...
            <div className="flex items-center gap-1.5">
                ...
                <p className="text-[10px] font-bold text-zinc-500 dark:text-zinc-500 uppercase">{subtext}</p>
            </div>
        </div>
    </Card>
);
