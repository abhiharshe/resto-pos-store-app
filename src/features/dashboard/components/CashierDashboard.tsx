...
const CashierDashboard = () => {
    ...
    return (
        <div className="space-y-6">
            <div className="bg-white dark:bg-neutral-800 p-8 rounded-3xl border border-mauve-200 dark:border-zinc-700 shadow-sm relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/5 rounded-full -mr-32 -mt-32" />
                <div className="relative z-10 space-y-2">
                    <h2 className="text-3xl font-black text-neutral-900 dark:text-white uppercase tracking-tight">Welcome, {user?.name || 'Cashier'}!</h2>
                ...
                <div className="lg:col-span-2 space-y-6">
                    <Card className="p-10 flex flex-col items-center justify-center text-center space-y-6 bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-900/10 dark:to-blue-900/10 border-indigo-100 dark:border-indigo-900/30">
                        ...
                        <div className="space-y-2">
                            <h3 className="text-2xl font-black text-neutral-900 dark:text-white uppercase tracking-tight">Open POS Terminal</h3>
                            <p className="text-neutral-500 dark:text-neutral-400 max-w-sm mx-auto">Click below to enter the Point of Sale screen and start taking new orders for {storeName}.</p>
                        </div>
                        <Button
                            variant="primary"
                            size="lg"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Card className="flex items-center gap-4 p-6 group hover:bg-neutral-50 dark:hover:bg-neutral-900/50 transition-all cursor-pointer" onClick={() => navigate('/orders')}>
                            <div className="w-12 h-12 rounded-2xl bg-neutral-100 dark:bg-mauve-900 flex items-center justify-center text-zinc-600 dark:text-zinc-400 group-hover:bg-amber-100 group-hover:text-amber-600 transition-colors">
                                <i className="ri-file-list-3-line text-2xl" />
                            </div>
                            <div>
                                <h4 className="text-sm font-semibold text-neutral-900 dark:text-white uppercase tracking-tight">Today's Orders</h4>
                                <p className="text-xs text-zinc-500">View and manage orders</p>
                            </div>
                        </Card>
                        <Card className="flex items-center gap-4 p-6 group hover:bg-neutral-50 dark:hover:bg-neutral-900/50 transition-all cursor-pointer" onClick={() => navigate('/customers')}>
                            <div className="w-12 h-12 rounded-2xl bg-neutral-100 dark:bg-mauve-900 flex items-center justify-center text-zinc-600 dark:text-zinc-400 group-hover:bg-green-100 group-hover:text-green-600 transition-colors">
                                <i className="ri-group-line text-2xl" />
                            </div>
                            <div>
                                <h4 className="text-sm font-semibold text-neutral-900 dark:text-white uppercase tracking-tight">Customers</h4>
                    ...
                    <Card>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-lg font-black text-neutral-900 dark:text-white">42</span>
                            </div>
                            <div className="flex items-center justify-between">
                            ...
                            <div className="h-2 w-full bg-neutral-100 dark:bg-mauve-900 rounded-full overflow-hidden">
