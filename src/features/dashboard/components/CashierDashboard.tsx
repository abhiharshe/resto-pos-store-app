        ...
        <div className="space-y-6">
            <div className="bg-white dark:bg-zinc-800 p-8 rounded-3xl border border-zinc-200 dark:border-zinc-700 shadow-sm relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-2">
                    ...
                    <p className="text-zinc-500 font-medium">Ready to serve customers at <span className="text-indigo-600 dark:text-indigo-400 font-bold">{storeName}</span>?</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Card className="flex items-center gap-4 p-6 group hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-all cursor-pointer" onClick={() => navigate('/orders')}>
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-zinc-900 dark:text-white uppercase tracking-tight">Today's Orders</h4>
                        ...
                        <Card className="flex items-center gap-4 p-6 group hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-all cursor-pointer" onClick={() => navigate('/customers')}>
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-zinc-900 dark:text-white uppercase tracking-tight">Customers</h4>
                ...
                <div className="space-y-6">
                    <Card>
                        <h4 className="text-sm font-bold text-zinc-400 uppercase tracking-widest mb-6">Daily Summary</h4>
                        <div className="space-y-6">
                            ...
                            <p className="text-[10px] text-zinc-400 font-bold uppercase text-center italic">75% of daily target reached</p>
                        </div>
                    </Card>
                    ...
                    <Card className="bg-amber-50 dark:bg-amber-900/10 border-amber-100 dark:border-amber-900/30">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="space-y-1">
                                <h4 className="text-sm font-bold text-amber-900 dark:text-amber-100 uppercase tracking-tight">Kitchen Alert</h4>
