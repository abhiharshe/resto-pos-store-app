        ...
        <div className="space-y-6">
            <div className="bg-neutral-900 border border-mauve-800 p-8 rounded-3xl text-white shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="space-y-1">
                        ...
                        <p className="text-amber-500 font-semibold tracking-widest uppercase text-xs">Head Chef at {storeName}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <Card>
                        <h4 className="text-sm font-semibold text-zinc-400 uppercase tracking-widest mb-6">Active Kitchen Load</h4>
                ...
                <div className="space-y-6">
                    <Card className="flex flex-col items-center text-center p-8 space-y-4">
                        <div className="w-20 h-20 rounded-full bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center text-indigo-600 font-semibold text-2xl uppercase border border-indigo-200 dark:border-indigo-800">
                            {user?.name?.[0]}
                        </div>
                        <div className="space-y-1">
                    ...
                    <Card className="bg-red-50 dark:bg-red-900/10 border-red-100 dark:border-red-900/30">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="space-y-1">
                                <h4 className="text-sm font-semibold text-red-900 dark:text-red-100 uppercase tracking-tight">Stock Alert</h4>
